...
public void mostrarTodos() {
    Pilha aux = new Pilha();
    Celula i = topo;
    // Transfere todos para a pilha auxiliar
    while (i != null) {
        aux.inserir(i.elemento);
        i = i.prox;
    }
    int indice = 0;
    for (Celula j = aux.topo; j != null; j = j.prox, indice++) {
        String texto = j.elemento.toString();
        if (texto.startsWith("=> ")) {
...
public class Q03 {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            Pilha pilha = new Pilha(); // estrutura de fila para jogos inseridos
            ...
            while (true) {
                ...
                try {
                    ...
                    if (g != null) pilha.inserir(g.clone());
