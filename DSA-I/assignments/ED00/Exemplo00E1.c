/*
 Exemplo00E1 - v0.0. - 11 / 08 / 2023
 Author: Matheus de Almeida Moreira - 848813

 Para compilar em terminal (janela de comandos):
 Linux : gcc -o exemplo00E1 exemplo00E1.c
 Windows: gcc -o exemplo00E1 exemplo00E1.c
...
void metodo51()
{
    // METODO PARA CONTAR 5 10 ATE' 1, RECURSIVAMENTE
    // identificar
...
void metodo53()
{
    // METODO RECURSIVO PARA MOSTRAR PARES_1
    // identificar
...
void metodo54()
{
    // METODO RECURSIVO PARA MOSTRAR PARES_2
    // identificar
...
void metodo55()
{
    // METODO RECURSIVO PARA SOMAR PARES_3
    // DADO:
    int SOMA;
    // identificar
...
void metodo56()
{
    // METODO RECURSIVO PARA SOMAR PARES_4
    // DADO :
    int SOMA = 0;
    // identificar
...
void metodo57()
{
    // METODO RECURSIVO PARA CONTAR PARES_5
    // identificar
...
void metodo58()
{
    // METODO RECURSIVO PARA ACHAR A POSICAO DE UMA LETRA
    // DADO :
    char L = '_';
    STRING30 S = "";
    // identificar
...
void metodo59()
{
    // METODO RECURSIVO PARA PROCURAR_2 UMA LETRA
    // DADO :
    char L = '_';
    STRING30 S = "";
    // identificar
...
void metodo60()
{
    // METODO RECURSIVO PARA PROCURAR_3 OCORRENCIAS DE UMA LETRA
    // DADO :
    char L = '_';
    STRING30 S = "";
...
void metodo61()
{
    ...
    // METODO PARA LER UMA TABELA DE INTEIROS
    // VARIAVEIS:
    TABELA V;
    int X = 0;
    // identificar
...
{
    typedef int TABELA[10];
    // METODO PARA SOMAR UMA TABELA DE INTEIROS
    // VARIAVEIS :
    TABELA V;
    int X = 0,
        SOMA = 0;
...
{
    typedef int TABELA[10];
    // METODO PARA CALCULAR A MEDIA DE UMA TABELA DE INTEIROS
    // VARIAVEIS :
    TABELA V;
    float MEDIA = 0.0;
    int X = 0,
...
{
    typedef char STRING10[10];
    // METODO PARA PROCURAR LETRA EM PALAVRA
    // VARIAVEIS :
    STRING10 PALAVRA;
    char LETRA = '_';
    int X = 0;
...
{
    typedef int MATRIZ[2][2];
    // METODO PARA MONTAR A TRANSPOSTA DE UMA MATRIZ
    // VARIAVEIS :
...
#define ORDEM 3
    ...
    // METODO PARA MOSTRAR A DIAGONAL DE UMA MATRIZ
    // VARIAVEIS :
    MATRIZ M;
    int X = 0, Y = 0;
    // identificar
...
void metodo71()
{
    ...
    // METODO PARA CALCULAR A DISTANCIA ENTRE PONTOS
    // DADOS:
    PONTOS P1, P2, P3;
    double D = 0.0;
    // identificar
...
void metodo81()
{
    ...
    // METODO PARA GRAVAR COORDENADAS DE PONTOS
    // DADOS:
    PONTOS P;
    int X = 0;
    FILE *A;
...
void metodo82()
{
    ...
    // METODO PARA LER ARQUIVO DE PONTOS
    // VARIAVEIS :
    PONTOS P;
    int X = 0;
    FILE *A;
...
void metodo85()
{
    ...
    // METODO PARA COPIAR O ARQUIVO COM COORDENADAS DE PONTOS
    // DADOS:
    PONTOS P;
    int X = 0;
    FILE *A1, *A2;
...
void metodo86()
{
    ...
    // METODO PARA ACRESCENTAR COORDENADAS DE PONTOS
    // DADOS:
    PONTOS P;
    int X = 0;
    FILE *A;
...
void metodo88()
{
    ...
    // METODO PARA PROCURAR COORDENADAS DE PONTOS
    // DADOS:
    PONTOS P,
        PROCURADO;
    bool ACHAR = false;
...
void metodo89()
{
    ...
    // METODO PARA ALTERAR COORDENADAS DE PONTOS
    // DADOS:
    PONTOS P;
    int X = 0;
    FILE *A;
...
void metodo90()
{
    ...
    // METODO PARA LER ARQUIVO DE PONTOS DIRETAMENTE
    // DADOS:
    PONTOS P;
    int X = 0;
    FILE *A;
...
void metodo91()
{
    ...
    // METODO PARA DEFINIR E MONTAR CELULA DE DADOS
    // DADOS:
    CELULA P;
    P.VALOR = 0;
    P.LINK = NULL;
...
void metodo97()
{
    ...
    // METODO PARA DEFINIR E MONTAR CELULAS DE DADOS
                                    // DADOS:
...
{
    printf("\n");
    printf("Exemplo00E1 - Programa = v0.0\n");
